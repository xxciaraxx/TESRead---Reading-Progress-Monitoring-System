...
<div class="app-shell">
    ...
    <aside class="sidebar" id="sidebar">
        ...
        <nav class="sidebar-nav">
            ...
            <div class="nav-section-label" style="margin-top:10px;">My Class</div>
            ...
            <a href="{{ route('teacher.interventions.index') }}"
               class="nav-item {{ request()->routeIs('teacher.interventions.*') ? 'active' : '' }}">
                <i class="fas fa-hands-helping"></i>
                <span>Interventions</span>
                @php
                    $activeInterv = \App\Models\Intervention::where('teacher_id', auth()->id())
                        ->where('status', 'Active')->count();
                @endphp
                @if($activeInterv > 0)
                    <span class="nav-badge">{{ $activeInterv }}</span>
                @endif
            </a>

            <a href="{{ route('teacher.reports.index') }}"
               class="nav-item {{ request()->routeIs('teacher.reports.*') ? 'active' : '' }}">
        ...
        <div class="sidebar-footer">
            <div class="dropdown">
                ...
                <div class="dropdown-menu" id="userMenu" style="bottom:100%;top:auto;left:0;right:auto;min-width:200px;">
                    <a href="{{ route('teacher.profile.edit') }}" class="dropdown-item">
    ...
    <div class="main-area">
        ...
        <header class="top-header">
            <button class="btn-icon" id="sidebarToggle"
                    style="display:none;background:rgba(255,255,255,0.15);border-color:rgba(255,255,255,0.3);color:#fff;"
